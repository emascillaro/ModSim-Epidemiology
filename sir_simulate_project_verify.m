function [S, I, R, W, total_people] = sir_simulate_project_verify(s_0, i_0, r_0, beta, gamma, lambda, mu, num_steps)
...
total_people = [326800000+66+0, s+i+r];
